...
session_libs = -lpipewire-0.3 -ldrmtap -lm -lEGL -lGL
...
install: session-caps
	...
	sudo cp xdg-desktop-portal-x11 /usr/lib/
	sudo cp xdg-desktop-portal-x11-session /usr/lib/
